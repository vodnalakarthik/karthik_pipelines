...
```text
Vercel Cron (weekdays at 19:30 UTC)
  -> GET /api/cron/daily-ingestion
  -> dailyIngestionWorkflow
       -> wait until 2:30 PM America/Chicago when necessary
...
At 19:30 UTC it is either 2:30 PM CDT or 1:30 PM CST. During standard time the coordinator uses a durable one-hour sleep before starting the pipelines. This keeps execution at 2:30 PM America/Chicago year-round while retaining one cron definition.
...
Start a local coordinator run outside the 1–2 PM scheduling window:
